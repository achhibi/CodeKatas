...
public class KataOfKatasTest
{
    ...
    void groupKatasByTechnologies()
    {
        ...
        ImmutableSetMultimap<Technology, Kata> techToKatas =
                Kata.ALL
                        .groupByEach(Kata::getTechnologies);
    ...
    void intersectKatasForKotlinAndScala()
    {
        ...
        ImmutableSetMultimap<Technology, Kata> technologyKata = Kata.ALL
                .groupByEach(Kata::getTechnologies);
        ImmutableSet<Kata> intersect = technologyKata
                .get(Language.KOTLIN)
                .intersect(technologyKata.get(Language.SCALA));
